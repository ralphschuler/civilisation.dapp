export const en = {
  ...
  screens: {
    march: {
      ...
      timing: {
        ...
        notesPlaceholder: "Notes about the attack...",
      },
      actions: { start: "Start march" },
      confirm: {
        title: "Confirm march",
        prefix: "Do you want to start the",
        to: "to",
        suffix: "now?",
        confirm: "Confirm",
      },
      preset: {
        ...
        createQuestion: "Do you want to save this army composition as a preset?",
        nameLabel: "Name",
        namePlaceholder: "e.g., Fast raid",
        descriptionLabel: "Description",
        descriptionPlaceholder: "e.g., Optimized for fast raids",
        create: "Create",
      },
      active: {
        title: "Active marches",
        empty: "No active marches",
        planFirst: "Plan first march",
        target: "Target",
        distance: "Distance",
        fields: "fields",
        units: "Units",
      ...
      presets: {
        ...
        deleteQuestionPrefix: "Do you really want to delete preset",
    ...
    settings: {
      ...
      gameplay: {
        autoCollect: "Auto-collect resources",
    ...
    more: {
      ...
      info: {
        ...
        syncAgo: "2min ago",
        description:
          "A mobile 4X-light strategy game in the style of Tribal Wars/Civilization. Build your city, train armies, and conquer provinces in asynchronous PvP battles.",
    ...
    reports: {
      ...
      empty: {
        title: "No reports",
        allRead: "All reports have been read.",
        noneInCategory: "No reports in this category.",
      },
      spy: {
        title: "Spy report",
        discovered: "Your spies were discovered!",
        resources: "Resources",
        units: "Units",
        buildings: "Buildings",
        level: "Level",
    ...
    marchReports: {
      ...
      battleReportTitle: "Battle report",
      units: "units",
      factors: {
      ...
      completed: {
        title: "Completed marches",
        empty: "No completed marches",
        target: "Target",
        arrival: "Arrival",
      },
      loot: "Loot",
      notes: "Notes",
      returning: {
        title: "Returning troops",
        empty: "No returning troops",
        from: "Returning from",
      },
      progress: "Progress",
      arrival: "Arrival",
    ...
    units: {
      overview: {
        title: "Army Overview",
        totalArmy: "Total army",
        noneTrained: "No units trained",
      },
      training: {
        title: "Train units",
        time: "Training time",
        required: "required",
        train: "Train",
        noneAvailable: "No units available",
        mustBuild: "Must be built first",
        mustBuildBarracks: "Barracks must be built first",
        buildHint: "Build a Barracks in the Village screen to train units",
        notEnough: "Not enough resources or population",
      },
    ...
    trade: {
      ...
      execute: "Trade",
      details: "Details",
      createTitle: "Create new trade offer",
      youOffer: "You offer:",
      ...
      validation: {
        ...
        enterDesired: "Enter a desired amount",
      },
    ...
    help: {
      ...
      faq: {
        ...
        resources: {
          ...
          answer:
            "Resources are produced automatically by your buildings. Tap the collect icon next to each resource to gather them. You can also upgrade production buildings to increase hourly income.",
        },
        buildings: {
          question: "How do I upgrade buildings?",
          answer:
            'Tap a building in your city and then "Upgrade". You need enough resources and a free build slot. Higher Town Hall levels unlock more build slots.',
        },
        army: {
          question: "How do I train units?",
          answer:
            "Go to the army tab and choose the unit to train. Each unit costs specific resources and population. Make sure you have enough Houses for population.",
        },
        combat: {
          question: "How does combat work?",
          answer:
            "Each unit has strengths and weaknesses. Cavalry is strong against ranged but weak against spearmen. Swordsmen are good against axemen. Use a mix of units for a balanced army.",
        },
        defense: {
          question: "How do I defend my city?",
          answer:
            "Build walls to protect your city. Higher wall levels provide better defense. Station defensive units in your city and watch reports for enemy attacks.",
        },
        world: {
          question: "How do I explore the world?",
          answer:
            "Use the world map to find other players, neutral camps, and resource fields. You can send scouts for intel or dispatch armies to attack.",
        },
      },
      tutorial: {
        "getting-started": {
      ...
      contact: {
        ...
        description:
          "Describe your issue as detailed as possible. We typically respond within 24 hours.",
    ...
    stats: {
      ...
      general: {
        ...
        totalBuildingLevels: "Total building levels",
      ...
      total: {
        ...
        totalResources: "Total resources collected",
        unitsTrained: "Units trained",
    ...
    building: {
      ...
      upgradeTitle: "Upgrade to level",
      costs: "Costs",
      benefits: "Improvements",
      benefit: {
        resource: "Increases resource production",
        military: "Unlocks better units and faster training",
        defense: "Improves village defense",
        special: "Improves special building functions",
      },
      notEnough: "Not enough resources",
    ...
    wallet: {
      minikitMissing: "MiniKit is not installed",
      runInApp: "This app has to be run using the Worldcoin app.",
      authenticate: "Authenticate",
    },
    notfound: { title: "Page not found", backHome: "Go back to home" },
    mint: {
      title: "Mint new village",
      description:
        "Villages are NFTs. Each player gets one free village at the start. If you lose your last village, you can mint a new one for 10 WORLD.",
      minting: "Mint in progress… This may take a few seconds.",
      success: "Successfully minted",
      transaction: "Transaction",
      free: {
        title: "Free starter village",
        available: "Available",
        used: "Already used",
        perk1: "Level 1 wall, secure starting resources",
        perk2: "Unique NFT affiliation",
        cta: "Mint free village",
        unavailable: "Not available",
        alreadyUsed: "Your free mint has already been used.",
      },
      paid: {
        title: "Mint village for 10 WORLD",
        balance: "Your WORLD balance",
        needFunds: "You need at least 10 WORLD to mint a new village.",
        cta: "Mint for 10 WORLD",
      },
      info: {
        title: "What does “village as NFT” mean?",
        point1: "You own your village on-chain; it is transferable.",
        point2: "If you lose your last village, you can mint a new one.",
        point3: "The first village is free; additional ones cost 10 WORLD.",
        preparing: "Preparing",
        running: "Running…",
      },
    },
  ...
  resources: {
    ...
    storage: {
      ...
      max: "Max",
      full: "Storage full",
      upgradeHint: "Upgrade via Storage building",
    },
    of: "of",
