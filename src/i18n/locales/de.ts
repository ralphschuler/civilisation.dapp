export const de = {
  ...
  screens: {
    march: {
      ...
      timing: {
        ...
        notesPlaceholder: "Notizen zum Angriff...",
      },
      actions: { start: "Marsch starten" },
      confirm: {
        title: "Marsch bestätigen",
        prefix: "Möchtest du den",
        to: "auf",
        suffix: "wirklich starten?",
        confirm: "Bestätigen",
      },
      preset: {
        createTitle: "Preset erstellen",
        createQuestion: "Möchtest du diese Armeezusammenstellung als Preset speichern?",
        nameLabel: "Name",
        namePlaceholder: "z.B. Schneller Raid",
        descriptionLabel: "Beschreibung",
        descriptionPlaceholder: "z.B. Optimiert für schnelle Plünderungen",
        create: "Erstellen",
      },
      active: {
        title: "Aktive Märsche",
        empty: "Keine aktiven Märsche",
        planFirst: "Ersten Marsch planen",
        target: "Ziel",
        distance: "Entfernung",
        fields: "Felder",
        units: "Einheiten",
      ...
      presets: {
        title: "Gespeicherte Presets",
        new: "Neu erstellen",
        empty: "Keine Presets gespeichert",
        createFirst: "Erstes Preset erstellen",
        deleteTitle: "Preset löschen",
        deleteQuestionPrefix: "Möchtest du das Preset",
        deleteQuestionSuffix: "wirklich löschen?",
        delete: "Löschen",
      },
    },
    achievements: {
    ...
    settings: {
      ...
      gameplay: {
        autoCollect: "Auto-Ressourcen sammeln",
    ...
    reports: {
      ...
      unreadSummary: {
        prefix: "Du hast",
        unread: "ungelesene Berichte",
        ofWhich: "davon",
        important: "wichtige",
      },
      empty: {
        title: "Keine Berichte",
        allRead: "Alle Berichte wurden bereits gelesen.",
        noneInCategory: "Keine Berichte in dieser Kategorie vorhanden.",
      },
      spy: {
        title: "Spionage-Bericht",
        discovered: "Deine Spione wurden entdeckt!",
    ...
    trade: {
      ...
      execute: "Handeln",
      details: "Details",
      createTitle: "Neues Handelsangebot erstellen",
      youOffer: "Du bietest an:",
      availableAmount: "Verfügbar",
      youWant: "Du möchtest:",
      exchangeRatio: "Tauschverhältnis",
      createOffer: "Angebot erstellen",
      validation: {
        enterAmount: "Gib eine Menge ein",
        notEnough: "Nicht genügend Ressourcen",
        enterDesired: "Gib eine gewünschte Menge ein",
      },
      historyTitle: "Handelsgeschichte",
      noHistory: "Noch keine Handelsgeschichte",
    },
    units: {
      overview: {
        title: "Armeeübersicht",
        totalArmy: "Gesamte Armee",
        noneTrained: "Noch keine Einheiten trainiert",
      },
      training: {
        title: "Einheiten ausbilden",
        time: "Ausbildungszeit",
        required: "benötigt",
        train: "Ausbilden",
        noneAvailable: "Keine Einheiten verfügbar",
        mustBuild: "Muss erst gebaut werden",
        mustBuildBarracks: "Kaserne muss erst gebaut werden",
        buildHint: "Baue eine Kaserne im Dorf-Screen, um Einheiten zu trainieren",
        notEnough: "Nicht genügend Ressourcen oder Bevölkerung",
      },
    ...
    stats: {
      ...
      general: {
        ...
        totalBuildingLevels: "Gesamt-Gebäudestufen",
        armyUnits: "Armeeeinheiten",
      ...
      total: {
        ...
        totalResources: "Gesamte Ressourcen gesammelt",
        unitsTrained: "Einheiten ausgebildet",
        buildingsUpgraded: "Gebäude ausgebaut",
        victories: "Siege",
        defeats: "Niederlagen",
      },
    ...
    building: {
      ...
      productionActive: "Produktion aktiv",
      defenseBuilding: "Verteidigungsgebäude",
      upgradeTitle: "Upgrade auf Level",
      costs: "Kosten",
      benefits: "Verbesserungen",
      benefit: {
        resource: "Erhöht die Ressourcenproduktion",
        military: "Ermöglicht bessere Einheiten und schnelleres Training",
        defense: "Verbessert die Dorfverteidigung",
        special: "Verbessert Spezialfunktionen des Gebäudes",
      },
      notEnough: "Nicht genügend Ressourcen",
      upgradeTo: "Auf Level",
      upgrade: "upgraden",
    ...
    wallet: {
      minikitMissing: "MiniKit ist nicht installiert",
      runInApp: "Diese App muss in der Worldcoin-App ausgeführt werden.",
      authenticate: "Authentifizieren",
    },
    notfound: { title: "Seite nicht gefunden", backHome: "Zur Startseite" },
    mint: {
      title: "Neues Dorf prägen",
      description:
      ...
      minting: "Mint wird ausgeführt… Dies kann einige Sekunden dauern.",
      success: "Erfolgreich geprägt",
      transaction: "Transaktion",
      free: {
        title: "Kostenloses Startdorf",
        available: "Verfügbar",
        used: "Bereits genutzt",
        perk1: "Level 1 Mauer, sichere Startressourcen",
        perk2: "Einzigartige NFT-Zugehörigkeit",
        cta: "Kostenloses Dorf prägen",
        unavailable: "Nicht verfügbar",
        alreadyUsed: "Dein kostenloses Mint wurde bereits verwendet.",
      },
      paid: {
        title: "Dorf für 10 WORLD prägen",
        balance: "Dein WORLD Guthaben",
        needFunds: "Du benötigst mindestens 10 WORLD, um ein neues Dorf zu prägen.",
        cta: "Für 10 WORLD prägen",
      },
      info: {
        title: "Was bedeutet „Dorf als NFT“?",
        point1: "Du besitzt dein Dorf on-chain; es ist übertragbar.",
        point2: "Bei Verlust deines letzten Dorfs kannst du ein neues prägen.",
        point3: "Das erste Dorf ist kostenlos, weitere kosten 10 WORLD.",
  ...
  resources: {
    ...
    storage: {
      ...
      max: "Max",
      full: "Lager voll",
      upgradeHint: "Ausbau über Lager-Gebäude",
    },
    of: "von",
    collectAll: "Alle sammeln",
    resources: "Ressourcen",
  },
  battle: {
    ...
    why: {
      titleWon: "Warum gewonnen?",
      titleLost: "Warum verloren?",
      counter: "Konter-Effekte",
      wall: "Mauer-Effekte",
      tech: "Technologie",
    },
  ...
  marchReports: {
    ...
    battleReportTitle: "Kampfbericht",
    units: "Einheiten",
    factors: {
      title: "Kampffaktoren",
    ...
    damage: "Schaden",
    stats: {
      title: "Marsch-Statistiken",
      total: "Märsche gesamt",
      winRate: "Erfolgsquote",
      totalLoot: "Beute gesamt",
      returning: "Rückkehrend",
    },
    tabs: { completed: "Abgeschlossen", returning: "Rückkehrend", analysis: "Analyse" },
    completed: {
      title: "Abgeschlossene Märsche",
      empty: "Noch keine abgeschlossenen Märsche",
      target: "Ziel",
      arrival: "Ankunft",
    },
    loot: "Beute",
    notes: "Notizen",
    returning: {
      title: "Rückkehrende Truppen",
      empty: "Keine rückkehrenden Truppen",
      from: "Rückkehr aus",
    },
    progress: "Fortschritt",
    arrival: "Ankunft",
    unknown: "Unbekannt",
    transporting: "Transportiert",
  },
  villageInfo: {
    title: "Dorfinfos",
    coords: "Koordinaten",
